...
This [homebridge](https://homebridge.io) plugin exposes controls to Apple's [HomeKit](http://www.apple.com/ios/home/) for a music player, like iTunes/Music or EyeTV, running on macOS.  It provides the following features:
...
- Install the latest v10 LTS version of Node.js.  On macOS, download the [12.x.x LTS](https://nodejs.org) installer.  This includes the `npm` package manager;
...
HomeKit is still relatively new, and Apple's [Home](https://support.apple.com/en-us/HT204893) app provides only limited support.  You might want to check out some other HomeKit apps, like Elgato's [Eve](https://www.elgato.com/en/eve/eve-app) (free), Matthias Hochgatterer's [Home+](https://hochgatterer.me/home/) (paid).
