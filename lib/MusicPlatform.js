...
const os = require('os')
const { MyHomeKitTypes, recommendedNodeVersion, semver } = homebridgeLib
...
module.exports = { MusicPlatform, setHomebridge }
...
function setHomebridge (homebridge) {
  ...
  const my = MyHomeKitTypes(homebridge)
...
function MusicPlatform (log, config, homebridge) {
  this.log = log
  ...
  this.catalina = semver.gte(os.release(), '19.0.0')
